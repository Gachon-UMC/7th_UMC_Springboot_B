...
public class QMemberAgree extends EntityPathBase<MemberAgree> {
    ...
    public final umc.study.domain.QAgreement agreement;
    ...
    public QMemberAgree(Class<? extends MemberAgree> type, PathMetadata metadata, PathInits inits) {
        ...
        this.agreement = inits.isInitialized("agreement") ? new umc.study.domain.QAgreement(forProperty("agreement")) : null;
